...
<div id="rightframe">
	...
	<main>
		...
		<p style="text-align:center">series:kill la kill</p>
		<p>Tag each picture with each character it includes using the character: tag, one for each character. For japanese characters, this means <span style="font-weight:bold;">lastname firstname</span></p>
		<p style="text-align:center">character:matoi ryuko</p>
		<p style="text-align:center">character:kiryuin satsuki</p>
	</main>
</div>
</div>
</body>
