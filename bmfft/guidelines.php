...
<div id="right_frame" style="width:100%;">
	...
	<div id="header" style="width:100%;">
		<div style="width:33%;float:left;"><a href="examples.php">examples</a></div>
	...
	<p>If you have any question, do not hesitate to post in the message pile or ask me on IRC or any of the other 20,000 ways we have to keep in touch!</p>
</div>
</div>
</body>
</html>