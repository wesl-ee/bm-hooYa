...
Type of media. Supported values are I<anime>, I<single_image>, and I<video> but
adding a new class only involves writing the code to render it.
...
Date that the tag was added. Not used for anything but cute to have
...
'series' -> 'puella_magi_madoka_magica'
...
Describes a member in a namespace, such as I<puella_magi_madoka_magica> or
I<kaname_madoka>
