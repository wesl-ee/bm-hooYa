...
function db_getrecent($page)
{
	...
	$query = "SELECT Id, Class, MAX(Added) AS last_activity, Indexed"
	...
	$query .= " GROUP BY Id"
	. " UNION SELECT Id, Class, Indexed AS last_activity, Indexed"
...
*/
function db_gethints($hint, $namespace = NULL)
{
	$dbh = mysqli_connect(CONFIG_MYSQL_HOOYA_HOST,
		CONFIG_MYSQL_HOOYA_USER,
		CONFIG_MYSQL_HOOYA_PASSWORD,
